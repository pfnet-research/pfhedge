...
def test_generate_brownian_mean_no_jump(device: str = "cpu"):
    ...
    output = generate_kou_jump(n_paths, n_steps, jump_per_year=0.0, device=device)
...
def test_generate_kou_jump_nosigma(device: str = "cpu"):
    torch.manual_seed(42)
    n_steps = 250

    result = generate_kou_jump(
...
def test_generate_kou_jump_std(device: str = "cpu"):
    torch.manual_seed(42)
    n_paths = 10000
    n_steps = 250
...
@pytest.mark.gpu
def test_generate_kou_jump_std_gpu():
    test_generate_kou_jump_std(device="cuda")


def test_generate_kou_jump_mean_init_state(device: str = "cpu"):
    torch.manual_seed(42)
    n_paths = 10000
    n_steps = 250
...
@pytest.mark.gpu
def test_generate_kou_jump_mean_init_state_gpu():
    test_generate_kou_jump_mean_init_state(device="cuda")


def test_generate_kou_jump_mean_mu(device: str = "cpu"):
    torch.manual_seed(42)
    n_paths = 10000
    n_steps = 250
    dt = 1 / 250
...
@pytest.mark.gpu
def test_generate_kou_jump_mean_mu_gpu():
    test_generate_kou_jump_mean_mu(device="cuda")
...
@pytest.mark.gpu
def test_generate_kou_jump_dtype_gpu():
    test_generate_kou_jump_dtype(device="cuda")


def test_generate_kou_jump_sobol_mean(device: str = "cpu"):
    n_paths = 10000
    n_steps = 250
...
@pytest.mark.gpu
def test_generate_kou_jump_sobol_mean_gpu():
    test_generate_kou_jump_sobol_mean(device="cuda")
