...
def main():
    ...
    experiments = [
        # Baseline
        {'name': 'Baseline (20 epochs)', 'n_epochs': 20, 'n_paths': 1000, 'n_layers': 3, 'n_units': 64, 'loss': 'expected_shortfall', 'loss_param': 0.5},

        # More training
        {'name': 'More epochs (50)', 'n_epochs': 50, 'n_paths': 2000, 'n_layers': 3, 'n_units': 64, 'loss': 'expected_shortfall', 'loss_param': 0.5},
        {'name': 'Even more (80)', 'n_epochs': 80, 'n_paths': 2000, 'n_layers': 3, 'n_units': 64, 'loss': 'expected_shortfall', 'loss_param': 0.5},

        # Architecture variations
        {'name': 'Deeper (5 layers)', 'n_epochs': 50, 'n_paths': 2000, 'n_layers': 5, 'n_units': 64, 'loss': 'expected_shortfall', 'loss_param': 0.5},
        {'name': 'Wider (128 units)', 'n_epochs': 50, 'n_paths': 2000, 'n_layers': 3, 'n_units': 128, 'loss': 'expected_shortfall', 'loss_param': 0.5},
        {'name': 'Deep+Wide', 'n_epochs': 60, 'n_paths': 3000, 'n_layers': 4, 'n_units': 128, 'loss': 'expected_shortfall', 'loss_param': 0.5},

        # Risk parameters
        {'name': 'Tail risk (p=0.1)', 'n_epochs': 50, 'n_paths': 2000, 'n_layers': 3, 'n_units': 64, 'loss': 'expected_shortfall', 'loss_param': 0.1},
        {'name': 'Entropic (a=1.0)', 'n_epochs': 50, 'n_paths': 2000, 'n_layers': 3, 'n_units': 64, 'loss': 'entropic', 'loss_param': 1.0},
        {'name': 'QuadCVaR (lam=2)', 'n_epochs': 50, 'n_paths': 2000, 'n_layers': 3, 'n_units': 64, 'loss': 'quadratic_cvar', 'loss_param': 2.0},

        # Best combination
        {'name': 'BEST COMBO', 'n_epochs': 80, 'n_paths': 3000, 'n_layers': 4, 'n_units': 128, 'loss': 'expected_shortfall', 'loss_param': 0.1},
    ]
