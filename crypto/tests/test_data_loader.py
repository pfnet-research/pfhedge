...
class TestCryptoDataLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_options_data = pd.DataFrame({
            ...
            'instrument': ['BTC-29DEC23-50000-C', 'BTC-29DEC23-50000-P', 'BTC-29DEC23-51000-C'],
    ...
    def test_load_perpetual_data(self):
        ...
        expected_spread = self.sample_perpetual_data['ask_price'] - self.sample_perpetual_data['bid_price']
