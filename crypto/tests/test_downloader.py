...
class TestHistoricalDataDownloader(unittest.TestCase):
    ...
    def test_download_perpetual_data(self, mock_sleep):
        ...
        with patch.object(self.downloader.client, 'get_ticker', return_value=mock_ticker_data):
    ...
    def test_download_options_data(self):
        ...
        with patch.object(self.downloader.client, 'get_instruments', return_value=mock_instruments), \
    ...
    def test_download_sample_dataset(self, mock_sleep):
        ...
        with patch.object(self.downloader.client, 'get_ticker') as mock_get_ticker, \
             patch.object(self.downloader.client, 'get_instruments', return_value=mock_instruments):
    ...
    def test_error_handling(self):
        ...
        with patch.object(self.downloader.client, 'get_ticker', side_effect=Exception("API Error")):
            start_date = datetime(2023, 1, 1, tzinfo=timezone.utc)
    ...
    def test_file_saving(self):
        ...
        with patch.object(self.downloader, 'download_perpetual_data', return_value=sample_data):
            # Enable saving
